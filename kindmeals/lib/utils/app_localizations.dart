...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'km': 'km',
      'show_needs_volunteer': 'Show donations needing volunteer assistance',
      'reset': 'Reset',
      ...
      'profile_not_found_recipient': 'Your profile was not found. Please ensure you are registered as a recipient to view donations.',
      'unable_to_load_donations': 'Unable to load donations at this time. Please try again later.',
      'retry': 'Retry',
      'go_to_profile': 'Go to Profile',
    ...
    'hi': {
      ...
      'no_hunger': 'हमारे समुदाय में किसी को भूखा नहीं रहना चाहिए',
      'food_waste': 'खाद्य अपशिष्ट से खाद्य स्वाद तक',
      ...
      'error_logout': 'लॉग आउट में त्रुटि: ',
      ...
      'refresh_authentication': 'प्रमाणीकरण रिफ्रेश करें',
      'sign_out_sign_in_again': 'साइन आउट करें और फिर से साइन इन करें',
      'go_to_profile': 'प्रोफाइल पर जाएँ',
      'go_back': 'वापस जाएँ',
      'refresh_profile_note': 'नोट: यदि आपने अभी-अभी पंजीकरण किया है, तो कृपया अपनी प्रोफ़ाइल स्थिति को रीफ्रेश करने के लिए लॉग आउट करें और फिर से लॉग इन करें।',
      ...
      'pickup_address_click_detect': 'पिकअप पत्ता (पता लगाने के लिए क्लिक करें)',
      'get_current_location': 'वर्तमान स्थान प्राप्त करें',
      'please_get_pickup_address': 'कृपया स्थान बटन पर क्लिक करके पिकअप पता प्राप्त करें',
      'location': 'स्थान',
      'expiry_date_time': 'समाप्ति तिथि और समय',
      'select_expiry_date_time': 'समाप्ति तिथि और समय चुनें',
      'please_select_expiry_date_time': 'Please select a valid expiry date and time',
      'local_time': 'स्थानीय समय',
      'need_volunteer_for_delivery': 'वितरण के लिए स्वयंसेवक की आवश्यकता है',
      'volunteer_note': 'नोट: जब आपका दान किसी प्राप्तकर्ता द्वारा स्वीकार किया जाता है, तो वे वितरण के लिए स्वयंसेवक का अनुरोध कर सकेंगे।',
      'donation_posted_successfully': 'दान सफलतापूर्वक पोस्ट किया गया!',
      'failed_to_post_donation': 'दान पोस्ट करने में विफल। कृपया पुनः प्रयास करें।',
      'authentication_error_refresh': 'प्रमाणीकरण त्रुटि: कृपया अपने क्रेडेंशियल्स को रीफ्रेश करने के लिए साइन आउट करें और फिर से साइन इन करें।',
      ...
      'km': 'किमी',
      'show_needs_volunteer': 'स्वयंसेवक सहायता की आवश्यकता वाले दान दिखाएं',
      'reset': 'रीसेट करें',
      ...
      'check_back_later': 'नए दान के लिए बाद में फिर से जांचें',
      'try_changing_filters': 'अधिक दान देखने के लिए अपने फ़िल्टर बदलने का प्रयास करें',
      'clear_filters': 'फ़िल्टर साफ़ करें',
      'profile_not_found_recipient': 'आपका प्रोफ़ाइल नहीं मिला। कृपया सुनिश्चित करें कि आप दान प्राप्त करने के लिए पंजीकृत हैं।',
      'unable_to_load_donations': 'इस समय दान लोड करने में असमर्थ। कृपया बाद में पुन: प्रयास करें।',
      'retry': 'पुन: प्रयास करें',
      'go_to_profile': 'प्रोफ़ाइल पर जाएं',
      'no_image_available': 'कोई इमेज उपलब्ध नहीं',
    ...
    'mr': {
      ...
      'no_donors_found': 'कोणतेही दानशूर सापडले नाहीत',
      ...
      'meal_brighten': 'एक जेवण कुणाचा पूर्ण दिवस उजळू शकते',
      ...
      'hunger_stat': '9 पैकी 1 व्यक्ती भुकेला राहतो',
      ...
      'all_rights_reserved': '© 2025 काइंडमील्स. सर्व हक्क राखीव.',
      ...
      'about': 'माहिती',
      'org_name': 'संस्थेचे नाव / वैयक्तिक',
      'user_type': 'प्रकार',
      'profile_pic': 'प्रोफाइल चित्र जोडा',
      'change_profile_pic': 'प्रोफाइल चित्र बदलें',
      'registration_successful': 'नोंदणी यशस्वी!',
      'get_address': 'कृपया स्थान बटणावर क्लिक करून तुमचा पत्ता घ्या',
      'type': 'प्रकार',
      'contact_number': 'संपर्क क्रमांक',
      ...
      'have_vehicle': 'तुमच्याकडे वितरणासाठी वाहन आहे का?',
      'vehicle_type': 'वाहन प्रकार',
      ...
      // Validation messages
      'enter_email': 'कृपया तुमचा ईमेल प्रविष्ट करा',
      ...
      'enter_about': 'कृपया स्वतःबद्दल माहिती प्रविष्ट करा',
      'enter_org_name': 'कृपया संस्थेचे नाव किंवा वैयक्तिक प्रविष्ट करा',
      'select_type': 'कृपया एक प्रकार निवडा',
      'select_vehicle_type': 'कृपया एक वाहन प्रकार निवडा',
      'enter_vehicle_number': 'कृपया तुमचा वाहन क्रमांक प्रविष्ट करा',
      ...
      'post_donation': 'दान पोस्ट करें',
      'refresh_authentication': 'प्रमाणीकरण रिफ्रेश करें',
      'sign_out_sign_in_again': 'साइन आउट करें आणि पुन्हा साइन इन करें',
      ...
      'please_get_pickup_address': 'कृपया स्थान बटणावर क्लिक करून पिकअप पत्ता मिळवा',
      'location': 'स्थान',
      ...
      'failed_to_post_donation': 'दान पोस्ट करण्यात अयशस्वी. कृपया पुन्हा प्रयत्न करा.',
      'authentication_error_refresh': 'प्रमाणीकरण त्रुटी: कृपया तुमची क्रेडेन्शियल्स रिफ्रेश करण्यासाठी साइन आउट करा आणि पुन्हा साइन इन करा.',
      'authentication_error': 'प्रमाणीकरण त्रुटी',
      'auth_error_details': 'तुमच्या दाता प्रोफाइलची पडताळणी करू शकलो नाही. हे असे झाले असू शकते:\n\n1. तुम्ही अलीकडेच नोंदणी केली आहे आणि तुमची प्रोफाइल पूर्णपणे सिंक झाली नाही आहे\n2. तुमचे प्रमाणीकरण टोकन कालबाह्य झाले आहे\n\nकृपया तुमची क्रेडेन्शियल्स रिफ्रेश करण्यासाठी साइन आउट करा आणि पुन्हा साइन इन करा.',
      'ok': 'ठीक आहे',
      ...
      'card': 'क्रेडिट/डेबिट कार्ड',
      'net_banking': 'नेट बँकिंग',
      'enter_valid_amount': 'कृपया वैध राशि प्रविष्ट करें',
      'amount_must_be_greater': 'रक्कम 10 पेक्षा जास्त असावी',
      'select_payment_method': 'कृपया पेमेंट पद्धत निवडा',
      'donate_caps': 'दान करा',
      ...
      'expired': 'कालबाह्य',
      'search_food_by_name': 'अन्न नावाने शोधा...',
      'no_filtered_donations_found': 'कोणतेही {0} दान सापडले नाही',
      'no_search_results_found': '"{0}" साठी कोणतेही परिणाम सापडले नाहीत',
      'unknown': 'अज्ञात',
      'created': 'तयार केले',
      ...
      'close': 'बंद करा',
      'accepted_by': 'स्वीकारकर्ता',
      'accepted_on': 'स्वीकृती तारीख',
      'expired_on': 'कालबाह्य झालेली तारीख',
      'signed_out': 'साइन आउट झाले',
      'sign_out_confirmation': 'तुम्हाला खात्री आहे की तुम्ही साइन आउट करू इच्छिता?',
      'sign_out': 'साइन आउट',
      'yes': 'होय',
      'no': 'नाही',
      'ok': 'ठीक आहे',
